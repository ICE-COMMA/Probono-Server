...
urlpatterns = [
    ...
    path('api/safety_info', views.safety_info, name='safety_info'),
    ...
    path('api/get_safety_guard_house/',views.get_safety_guard_house,name='get_safety_guard_house'),
    path('api/get_bus_no_to_route/', views.get_bus_no_to_route, name='get_bus_no_to_route'),
